...
router.post('/newuser', (req, res) => {
    ...
    /* The command for SQL query we want to add data to the database. */
...
router.get('/tickets', function (req, res) {
    /* The command for SQL query we want to select all data from the database. */
...
router.get('/ticket/:ticket_code', function (req, res) {
    ...
    /* The SQL query we want to select data by ticket_code from the database. */
...
//TEST CASE: 1
//method: GET
//URL: http://localhost:3030/ticket/TK_01
...
router.post('/searchticket', (req, res) => {
    ...
    /* The command of SQL query that we want to select data from the database by name, location, and date. */
    let queryString = `select * from ticket where ticket_title like '%${ticket_title}%' and 
                                                    ticket_loca like '%${ticket_loca}%' and
                                                    ticket_date like '%${ticket_date}%';`;
...
router.post('/insertticket', function (req, res) {
    ...
    connection.query(insertSql, function (error, insertResults) {
        ...
        res.json({ finish: "true", "message": "Ticket has been inserted successfully." });
    });
});
...
// {
//     "t_code": "TK_12",
//     "t_title": "OONRAK WARRIOS",
//     "t_img": "https://res.theconcert.com/w_600,h_800,c_thumb/381761a0ad60c93089d3cb0a8f3fda639/oonrak_kv_theconcert.jpg",
//     "t_desc": "The ultimate light-hearted annual concert of the Ban Unrak gang.Prepare to explode the fun, full of all flavors. 6 rings, 6 hours of clogged teeth!!",
//     "t_loca": "JJ HALL",
//     "t_date": "2023-05-27",
//     "t_time": "17:00:00",
//     "t_price": 1099
...
//     "t_img": "https://res.theconcert.com/w_600,h_800,c_thumb/8d74f3f2f254bf1a15d0af29fb221a619/fjjud_kv_final_theconcert.jpg",
//     "t_desc": "GET READYYYYYYY TO FUNGJAIIII",
//     "t_loca": "Union Mall",
//     "t_date": "2023-06-04",
//     "t_time": "12:00:00",
//     "t_price": 777
